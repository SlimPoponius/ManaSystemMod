...
public class PurifiedMonsterCrystalItem extends Item {

    public PurifiedMonsterCrystalItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        if(!pPlayer.level.isClientSide){
            ...
            ManaManager.get(pLevel).loseMana(mCur + 500);
            ManaManager.get(pLevel).addSouls(50);
