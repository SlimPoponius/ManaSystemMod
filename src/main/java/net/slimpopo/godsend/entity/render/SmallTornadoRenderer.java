...
public class SmallTornadoRenderer<Type extends TornadoEntity> extends GeoEntityRenderer<TornadoEntity> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(GodSend.MOD_ID,"textures/entity/tornado.png");

    public SmallTornadoRenderer(EntityRendererProvider.Context context) {
        super(context, new SmallTornadoModel<>());
    }
