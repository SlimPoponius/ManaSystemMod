...
public class SmallTornadoModel<Type extends TornadoEntity> extends AnimatedGeoModel<Type> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(GodSend.MOD_ID, "tornado_small"), "main");
