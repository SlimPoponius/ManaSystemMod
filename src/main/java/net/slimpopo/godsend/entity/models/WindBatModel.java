...
public class WindBatModel extends HierarchicalModel<WindBatEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(GodSend.MOD_ID, "wind_bat"), "main");

    public WindBatModel(ModelPart pRoot) {
        this.root = pRoot;
    ...
    @Override
    public void setupAnim(WindBatEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
